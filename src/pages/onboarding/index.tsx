...
const OnBoarding = () => {
    const { getUserHiveDetails, userhiveDetails, setUserHiveDetails } = useAppStore();
        ...
        <Box minHeight={'100vh'}>
            <Flex flexDirection={'column'} padding={'20px'} height={'100%'} width='100%' justifyContent={'center'} alignItems='center'>
                <Card height={'100%'} width='100%'>
                    <CardBody>
                        <Box border={'1px solid'} borderRadius='10px' width={'40%'} padding='10px' paddingX={'50px'} paddingTop={'20px'} margin='auto' height={'80vh'}>
                ...
                <Box  {...getRootProps()} cursor={'pointer'} borderRadius={'50%'} height={'200px'} width='200px' border={'1px solid'}>
                  ...
                  <img src={selectedFile?selectedFile.previewUrl:'/images/avatar3.png'} style={{margin:'0', width:'100%', borderRadius:'100px', height:'100%', objectFit:'cover'}} />
                            ...
                            <Flex justifyContent={'center'} alignItems='center' marginTop={'10px'} width='100%' >
                                <Text as='h2'>
                                    Lets start with adding of display name
                                </Text>
                            </Flex>
                            ...
                            <Flex cursor={'pointer'} onClick={() => router.push('/onboarding/profile')} justifyContent={'center'} alignItems='center' padding={'0'} marginTop={'100px'} width='100%' >
                                <Button width={'xl'} colorScheme='blue'>Save</Button>
                            </Flex>
                            ...
                            <Flex cursor={'pointer'} onClick={() => router.push('/onboarding/profile')} justifyContent={'center'} alignItems='center' marginTop={'10px'} width='100%' >
                                <Text as='span'>
                                    Skip
                                </Text>
                            </Flex>
