...
const OnBoarding = () => {
    ...
    const requestBroadcast = () => {
        try {
            ...
            keychain.requestBroadcast("juneroy1", [
                [
                    "account_update2", {
                        "account": "juneroy1",
                        "json_metadata": "",
            ...
            <Flex flexDirection={'column'} padding={'20px'} height={'100%'} width='100%' justifyContent={'center'} alignItems='center'>
                <Card height={'100%'} width='100%'>
                    <CardBody>
                        ...
                        <Box border={'1px solid'} borderRadius='10px' width={'40%'} padding='10px' paddingX={'50px'} paddingTop={'20px'} margin='auto' minHeight={'80vh'}>
                            ...
                            <Flex cursor={'pointer'} onClick={() => requestBroadcast()} justifyContent={'center'} alignItems='center' padding={'0'} marginTop={'10px'} width='100%' >
