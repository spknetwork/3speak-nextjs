...
const OnBoarding = () => {
  ...
  const [selectedFileProfile, setSelectedFileProfile] = useState<FilePreview | null>(null);
      ...
      <Flex flexDirection={'column'} padding={'20px'} height={'100%'} width='100%' justifyContent={'center'} alignItems='center'>
        <Card height={'100%'} width='100%'>
          <CardBody>
            ...
            <Box border={'1px solid'} borderRadius='10px' width={'60%'} padding='10px' paddingTop={'20px'} margin='auto' height={'80vh'}>
              <Flex position={'relative'} justifyContent={'start'} height={'400px'} width='100%' >

                <Flex {...getRootProps()} cursor={'pointer'} justifyContent={'center'} height={'300px'} width='100%' >
                  <Flex justifyContent={'center'} alignItems='center' fontSize={{
                    base: "60px",
                    md: "60px",
                    lg: "100px",
                  }} borderRadius={'10px'} height={'300px'} width='100%' border={'1px solid'}>
                    <input {...getInputProps()} />
                    {
                      (coverImage || selectedFile) && (
                        <img src={coverImage?coverImage:selectedFile?.previewUrl} style={{ margin: '0', width: '100%', height: '100%', objectFit: 'cover' }} />
                      )
                    }
                    {
                ...
                <Box left={'38%'} top='205px' position={'absolute'} background={'white'} {...getRootPropsProfile()} cursor={'pointer'} borderRadius={'50%'} height={'200px'} width='200px' border={'1px solid'}>
                  <input {...getInputPropsProfile()} />
                  <img src={profileImage?profileImage: selectedFileProfile ? selectedFileProfile.previewUrl : '/images/avatar3.png'} style={{ margin: '0', width: '100%', borderRadius: '100px', height: '100%', objectFit: 'cover' }} />
                </Box>
              </Flex>
              <Flex justifyContent={'center'} alignItems='center' marginTop={'10px'} width='100%' >
                <Text as='h2'>
                  Add profile and banner
                </Text>
              </Flex>
              ...
              <Flex cursor={'pointer'} onClick={() => router.push('/onboarding/details')} justifyContent={'center'} alignItems='center' padding={'10px'} marginTop={'10px'} width='100%' >
                <Button width={'lg'} colorScheme='blue'>Save photo</Button>
              </Flex>
